...
from dbt.contracts.graph.parsed import ParsedModel, ParsedTest, ParsedMacro, \
    ParsedNodePatch, ParsedSourceDefinition, make_parsed_node
...
class ParserTest(BaseParserTest):
    ...
    def test__single_model(self):
        ...
        self._assert_parsed_sql_nodes(
            ...
            {
                'model.root.model_one': ParsedModel(
                    alias='model_one',
                    name='model_one',
                    database='test',
                    schema='analytics',
    ...
    def test__simple_dependency(self):
        ...
        self._assert_parsed_sql_nodes(
            parser.parse_sql_nodes(models),
            {
                ...
                'model.root.events_tx': ParsedModel(
                    alias='events_tx',
                    name='events_tx',
                    database='test',
                    schema='analytics',
    ...
    def test__multiple_dependencies(self):
        ...
        self._assert_parsed_sql_nodes(
            parser.parse_sql_nodes(models),
            {
                ...
                'model.root.sessions': ParsedModel(
                    alias='sessions',
                    name='sessions',
                    database='test',
                    schema='analytics',
                ...
                'model.root.sessions_tx': ParsedModel(
                    alias='sessions_tx',
                    name='sessions_tx',
                    database='test',
                    schema='analytics',
    ...
    def test__multiple_dependencies__packages(self):
        ...
        self._assert_parsed_sql_nodes(
            parser.parse_sql_nodes(models),
            {
                ...
                'model.snowplow.sessions': ParsedModel(
                    alias='sessions',
                    name='sessions',
                    database='test',
                    schema='analytics',
                ...
                'model.snowplow.events_tx': ParsedModel(
                    alias='events_tx',
                    name='events_tx',
                    database='test',
                    schema='analytics',
                ...
                'model.snowplow.sessions_tx': ParsedModel(
                    alias='sessions_tx',
                    name='sessions_tx',
                    database='test',
                    schema='analytics',
    ...
    def test__process_refs__packages(self):
        ...
        manifest = Manifest(
            nodes={
                k: make_parsed_node(**v)
                for (k, v) in graph['nodes'].items()
            },
            macros={
                k: ParsedMacro(**v)
                for (k, v) in graph['macros'].items()},
            docs={},
    ...
    def test__root_project_config(self):
        ...
        self._assert_parsed_sql_nodes(
            parser.parse_sql_nodes(models),
            {
                ...
                'model.root.ephemeral': ParsedModel(
                    alias='ephemeral',
                    name='ephemeral',
                    database='test',
                    schema='analytics',
    ...
    def test__other_project_config(self):
        ...
        self._assert_parsed_sql_nodes(
            ...
            parsed={
                ...
                'model.snowplow.multi_sort': ParsedModel(
                    alias='multi_sort',
                    name='multi_sort',
                    database='test',
                    schema='analytics',
    ...
    def test__simple_data_test(self):
        ...
        self._assert_parsed_sql_nodes(
            ...
            {
                'test.root.no_events': ParsedTest(
                    alias='no_events',
                    name='no_events',
                    database='test',
                    schema='analytics',
